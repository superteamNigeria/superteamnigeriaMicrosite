...
// Change skeleton (loading shimmer) to be dark neutral
const Skeleton = ({
  className,
  ...props
}: React.HTMLAttributes<HTMLDivElement>) => {
  return (
    <div className={cn("bg-neutral-800 rounded-md", className)} {...props} />
  );
};
    ...
    <div className="flex items-center space-x-2">
      ...
      <div>
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex items-center font-semibold whitespace-nowrap text-neutral-100"
        >
        ...
        <div className="flex items-center space-x-1">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-sm text-neutral-400 transition-all duration-75"
          >
...
// Body: text is always neutral-100, links are blue-400, muted types are neutral-400
...
// Media: media area uses border-neutral-700 and dark backgrounds, images are not brightened
    ...
    <div className="flex flex-1 items-center justify-center">
      {tweet.video && (
        <video
          ...
          muted
          playsInline
          className="rounded-xl border border-neutral-700 shadow-sm bg-black"
        >
        ...
        <div className="relative flex transform-gpu snap-x snap-mandatory gap-4 overflow-x-auto">
          ...
          {tweet.photos.map((photo) => (
            <img
              ...
              alt={tweet.text}
              className="h-64 w-5/6 shrink-0 snap-center snap-always rounded-xl border border-neutral-700 object-cover shadow-sm bg-neutral-900"
            />
          ))}
          <div className="shrink-0 snap-center sm:w-2" />
        </div>
      ...
      {!tweet.video &&
        ...
        tweet?.card?.binding_values?.thumbnail_image_large?.image_value.url && (
          <img
            ...
            className="h-64 rounded-xl border border-neutral-700 object-cover shadow-sm bg-neutral-900"
            alt={tweet.text}
          />
        )}
    </div>
...
export const MagicTweet = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-fit w-full max-w-sm flex-col gap-2 overflow-hidden rounded-2xl border border-neutral-700 bg-neutral-950 p-4 backdrop-blur-md text-neutral-100",
        className
      )}
      {...props}
    >
